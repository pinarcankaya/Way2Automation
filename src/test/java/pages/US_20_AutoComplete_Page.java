...
public class US_20_AutoComplete_Page {

    public US_20_AutoComplete_Page() {
    ...
    public  List<WebElement> textBoxList;  //herhangi bir harf girdikten sonra cikan sonuclar ayni class degerlerine sahip
}
